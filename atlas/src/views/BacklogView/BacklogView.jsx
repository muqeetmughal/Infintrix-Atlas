...
const INITIAL_PROJECT = {
  name: "PROJ-0002",
  execution_mode: "Scrum",
};

const INITIAL_CYCLES = [
  {
    name: "CYC-01",
    title: "Sprint 12: API Core",
    status: "Active",
    start_date: "May 01",
    end_date: "May 14",
  },
...
const INITIAL_TASKS = [
  ...
  {
    id: "T-102",
    subject: "Fix Header Overflow on Mobile",
    task_type: "Bug",
    status: "In Progress",
    cycle: "CYC-01",
  },
  {
    id: "T-103",
    subject: "Implement Stripe Webhooks",
    task_type: "Epic",
    status: "Backlog",
    cycle: null,
  },
  {
    id: "T-104",
    subject: "Database Migration to RDS",
    task_type: "Task",
    status: "Backlog",
    cycle: null,
  },
