...
const INITIAL_TASKS = [
  {
    id: 1,
    name: "TASK-001",
    subject: "Initial Wireframes",
    project: "PROJ-001",
    status: "Open",
    priority: "Medium",
    exp_start_date: "2024-05-01",
    exp_end_date: "2024-05-10",
    assignee: "Unassigned",
  },
  {
    id: 2,
    name: "TASK-002",
    subject: "Backend API Setup",
    project: "PROJ-002",
    status: "Working",
    priority: "High",
    exp_start_date: "2024-05-05",
    exp_end_date: "2024-05-15",
    assignee: "John Doe",
  },
  {
    id: 3,
    ...
    status: "Completed",
    priority: "Urgent",
    exp_start_date: "2024-04-20",
    exp_end_date: "2024-04-30",
    assignee: "Jane Smith",
  },
  {
    id: 4,
    ...
    status: "Working",
    priority: "Medium",
    exp_start_date: "2024-05-02",
    exp_end_date: "2024-05-20",
  ...
  },
  {
    ...
    exp_end_date: "2023-12-05",
    assignee: "Sarah Chen",
  },
  {
    id: 6,
    name: "TASK-006",
    subject: "User Interview Sessions",
    project: "PROJ-001",
    status: "Pending Review",
    priority: "High",
    exp_start_date: "2024-05-10",
    exp_end_date: "2024-05-18",
    assignee: "Mike Ross",
  },
];
...
const Badge = ({ children, className }) => (
  <span
    className={`px-2 py-0.5 rounded-md text-[10px] font-bold border uppercase tracking-wider ${className}`}
  >
    {children}
  </span>
);
  ...
  const handleGenerate = async () => {
    ...
    setTimeout(() => {
      const mockAISuggestions = [
        {
          id: Date.now() + 1,
          subject: "Draft Technical Specification Document",
          priority: "High",
          weight: 3,
        },
        {
          id: Date.now() + 2,
          subject: "Conduct Competitor UI/UX Benchmarking",
          priority: "Medium",
          weight: 2,
        },
        {
          id: Date.now() + 3,
          subject: "Configure CI/CD Pipelines for Staging",
          priority: "Urgent",
          weight: 5,
        },
        {
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="text-center space-y-3">
        ...
        <p className="text-slate-500 max-w-lg mx-auto">
          Upload your requirements and watch as AI deconstructs them into
          professional ERPNext tasks.
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {suggestedTasks.map((task) => (
              <div
                key={task.id}
                className="bg-white border border-slate-200 rounded-2xl p-5 flex items-center justify-between hover:shadow-md transition-all group"
              >
      ...
      <div className="flex justify-between items-end mb-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Optimize your workflow by assigning dozens of tasks in one go.
          </p>
        </div>
      </div>
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-50">
            {tasks.map((task) => (
              <tr
                key={task.id}
                className={`hover:bg-indigo-50/30 transition-colors group ${selectedIds.includes(task.id) ? "bg-indigo-50/50" : ""}`}
              >
                <td className="p-6">
                  <input
                    type="checkbox"
      ...
      <div className="flex-1 overflow-x-auto pb-6">
        <div className="flex space-x-6 min-w-max h-full">
          {statuses.map((status) => (
            <div
              key={status}
              className="w-80 bg-slate-50/50 rounded-3xl border border-slate-100 flex flex-col p-4"
            >
              ...
              <div className="flex-1 space-y-4 overflow-y-auto pr-2 custom-scrollbar">
                {tasks
                  ...
                  .map((task) => (
                    <div
                      key={task.id}
                      className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer group"
                    >
                      ...
                      <h5 className="font-bold text-slate-900 leading-tight mb-4">
                        {task.subject}
                      </h5>
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[800px]">
            ...
            <div className="flex border-b border-slate-100 bg-slate-50/50">
              <div className="w-64 p-4 border-r border-slate-100 font-bold text-xs text-slate-400 uppercase tracking-widest">
                Tasks
              </div>
              <div className="flex-1 flex">
                {["May 01", "May 08", "May 15", "May 22", "May 29"].map(
                  (date) => (
                    <div
                      key={date}
                      className="flex-1 p-4 text-center text-[10px] font-bold text-slate-400 border-r border-slate-50"
                    >
                      {date}
                    </div>
                  ),
            ...
            >
              ...
              {isSidebarOpen && (
                <span className="text-sm flex items-center justify-between flex-1">
                  ...
                  {item.highlight && (
                    <span
                      className={`text-[9px] px-2 py-0.5 rounded-full uppercase tracking-tighter font-black ${activeTab === item.id ? "bg-indigo-400 text-white" : "bg-indigo-100 text-indigo-700"}`}
                    >
                      AI
                    </span>
                  )}
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex items-center space-x-6">
            <div className="hidden md:flex items-center bg-slate-100 px-4 py-2 rounded-2xl border border-slate-200">
              ...
              <input
                ...
                className="bg-transparent border-none text-sm focus:ring-0 w-48 font-medium"
              />
            </div>
        ...
        <div className="p-10 overflow-y-auto flex-1 custom-scrollbar">
          <div className="max-w-7xl mx-auto">
              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex items-center space-x-4"
                    >
                      <div
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  >
                    <div className="space-y-6">
                      {[
                        {
                          text: "AI generated 4 new tasks for App Dev",
                          time: "2m ago",
                        },
                        {
                          text: "Bulk assigned 12 tasks to Mike Ross",
                          time: "1h ago",
                        },
                        {
                          text: "Project Migration marked Completed",
                          time: "4h ago",
                        },
                      ].map((act, i) => (
            ...
            {activeTab === "ai-gen" && (
              <AIGeneratorView onAcceptTask={handleAcceptAITask} />
            )}
            {activeTab === "bulk-assign" && (
              <BulkAssignView tasks={tasks} onBulkUpdate={handleBulkUpdate} />
            )}
            {activeTab === "kanban" && <KanbanView tasks={tasks} />}
            {activeTab === "gantt" && <GanttView tasks={tasks} />}
            {activeTab === "tree" && (
              <TreeView projects={projects} tasks={tasks} />
            )}
